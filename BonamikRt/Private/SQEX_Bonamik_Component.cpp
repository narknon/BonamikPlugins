...
void USQEX_Bonamik_Component::SQEX_SetEmissiveWindScale(const TArray<FName>& Groups, const float Scale, bool bApplyToChildren) {
}
...
void USQEX_Bonamik_Component::SQEX_Bonamik_SetWorldWindScale(const TArray<FString>& Groups, float Scale, bool bApplyToChildren) {
}
...
void USQEX_Bonamik_Component::SQEX_Bonamik_SetOuterConeScale(const TArray<FString>& Groups, float Scale, bool bApplyToChildren) {
}

void USQEX_Bonamik_Component::SQEX_Bonamik_SetMassScale(const TArray<FString>& Groups, float Scale, bool bApplyToChildren) {
}

void USQEX_Bonamik_Component::SQEX_Bonamik_SetLocalForceScale(const TArray<FString>& Groups, float Scale, bool bApplyToChildren) {
}

void USQEX_Bonamik_Component::SQEX_Bonamik_SetInnerConeScale(const TArray<FString>& Groups, float Scale, bool bApplyToChildren) {
}
...
void USQEX_Bonamik_Component::SQEX_Bonamik_SetGroupParamExt(const TArray<FSQEX_BonamikChangingParameterExt>& GroupParam) {
}
...
void USQEX_Bonamik_Component::SQEX_Bonamik_SetEmissiveWind(const TArray<FName>& Groups, TEnumAsByte<ESQEX_Bonamik_EmissiveDirection> DirectionSpace, const FVector& DirectionVec, float BaseStrength, float WaveAmplitude, float WaveFreq, float BlendTime, bool bApplyToChildren) {
}
...
void USQEX_Bonamik_Component::SQEX_Bonamik_ScaleGroupParam(const TArray<FSQEX_BonamikChangingParameter>& GroupParam) {
}

void USQEX_Bonamik_Component::SQEX_Bonamik_RestoreGroupParamExt(const TArray<FSQEX_BonamikChangingParameterExt>& GroupParam) {
}
